# Purpose
    To backup (at short frequncies e.g. 30 minutes) the important and fast growing tables in a database. This script can be used in adjunct to other scripts, those can be copying this data simultaneously to another storage/computer/server. 
